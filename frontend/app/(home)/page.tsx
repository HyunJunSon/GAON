        ...
        <div className="flex items-center justify-between">
          <div className="flex-1">
            <div className="flex items-center gap-3 mb-3">
              ...
              <h3 className="text-xl font-bold">현재 관계 온도</h3>
            </div>
            <p className="text-orange-100 leading-relaxed">최근 대화를 바탕으로 측정된 관계의 따뜻함 정도입니다</p>
          </div>
          <div className="text-right ml-6">
            <div className="text-5xl font-bold mb-1">36.5°</div>
            <div className="text-orange-200 text-lg font-medium">따뜻함</div>
          </div>
        </div>
      </div>
